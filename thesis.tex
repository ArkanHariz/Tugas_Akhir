...
% 	\rfoot{Halaman \thepage}%
    ...
    \title{ANALISIS PERFORMA ARSITEKTUR \textit{RESNET-18} DAN \textit{RESNET-50} DENGAN PENERAPAN AUGMENTASI DATA KELAS MINORITAS PADA DATASET DERMAMNIST}
    % Judul Tugas Akhir dalam Bahasa Inggris
    \titleEN{\textit{ANALYSIS PERFORMANCE OF RESNET-18 AND RESNET-50 ARCHITECTURES WITH THE APPLICATION OF MINORITY CLASS DATA AUGMENTATION ON THE DERMAMNIST DATASET}}
    % JUDUL AKAN DITULIS DALAM HURUF KAPITAL; Font size 16 pt; Bold; Tidak melebihi 4 baris
    
    % Informasi Mahasiswa
    \author{Arkan Hariz Chandrawinata Liem}		% Nama Mahasiswa
	\nim{122140038}				% NIM Mahasiswa
	
	%Informasi Dosen Pembimbing
	\dosbingA%
		{Hartanto Tantriawan, S.Kom., M.Kom.}%			% Nama Dosen Pembimbing 1
		{NIP. 19920522 2019 03 1 012}	% NIP Dosen Pembimbing 1
		
	%Informasi Dosen Penguji
	\pengujiA%
		{Mohamad Idris, S.Si., M.Sc.}%				% Nama Dosen Penguji 1
		{NIP. 19861010 2019 03 1 016}	% NIP Dosen Penguji 1
	\pengujiB%
		{Alya Khairunnisa Rizkita, S.Kom., M.Kom.}%				% Nama Dosen Penguji 2
		{NIP. 19990915 2025 06 2 011}	% NIP Dosen Penguji 2
