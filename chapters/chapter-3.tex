...
\begin{figure}[H] % Kalau menggunakan H, posisi gambar akan tepat dibawah teks
    \centering
    \fbox{\includegraphics[width=1.0\textwidth]{figure/alur_penelitian.png}}
...
yang digunakan dalam penelitian seperti jumlah kelas, distribusi data dari 
masing-masing kelas, dan ukuran dari citra penyakit kulit. Pada 
...
augmentasi data yang dikhususkan untuk kelas minoritas. Penelitian 
sebelumnya dan penelitian yang dilakukan sama-sama menggunakan 
arsitektur \textit{ResNet-18} dan \textit{ResNet-50}, namun terdapat 
beberapa perbedaan pada modifikasi teknis di dalam arsitekturnya. \par
...
\begin{figure}[H] % Kalau menggunakan H, posisi gambar akan tepat dibawah teks
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{figure/resnet_punya_saya_TA.png}}
    \caption{Visualisasi Arsitektur \textit{ResNet-18} Dengan \textit{Dropout}}
    \label{fig:3.resnet18_dropout}
\end{figure}

\begin{figure}[H] % Kalau menggunakan H, posisi gambar akan tepat dibawah teks
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{figure/resnet_punya_saya_TA2.png}}
    \caption{Visualisasi Arsitektur \textit{ResNet-50} Dengan \textit{Dropout}}
    \label{fig:3.resnet50_dropout}
\end{figure}
...
memiliki distribusi data yang tidak seimbang antar kelasnya. Pada penelitian yang dilakukan, ditambahkan \textit{dropout} dengan 
...
pada data baru. Visualisasi dari arsitektur \textit{ResNet-18} dengan 
\textit{dropout} dapat dilihat pada Gambar \ref{fig:3.resnet18_dropout} dan 
visualisasi dari arsitektur \textit{ResNet-50} dengan \textit{dropout} dapat 
dilihat pada Gambar \ref{fig:3.resnet50_dropout}. \par
...
dari kelas mayoritas karena jumlah datanya yang jauh lebih banyak. Pada 
penelitian yang dilakukan, diterapkan \textit{class weight} yang 
...
\begin{figure}[H] % Kalau menggunakan H, posisi gambar akan tepat dibawah teks
    \centering
    \fbox{\includegraphics[width=0.5\textwidth]{figure/lapisan_konvolusi.png}}
...
\begin{figure}[H] % Kalau menggunakan H, posisi gambar akan tepat dibawah teks
    \centering
    \fbox{\includegraphics[width=0.5\textwidth]{figure/kernel.png}}
...
\begin{figure}[H] % Kalau menggunakan H, posisi gambar akan tepat dibawah teks
    \centering
    \fbox{\includegraphics[width=1.0\textwidth]{figure/proses_konvolusi.png}}
...
Gambar \ref{fig:3.endkonv}.

\begin{figure}[H] % Kalau menggunakan H, posisi gambar akan tepat dibawah teks
    \centering
    \fbox{\includegraphics[width=1.0\textwidth]{figure/proses_konvolusi_2.png}}
    \caption{Contoh Hasil Konvolusi}
...
\begin{figure}[H] % Kalau menggunakan H, posisi gambar akan tepat dibawah teks
    \centering
    \fbox{\includegraphics[width=0.4\textwidth]{figure/hasil_akhir_konvolusi.png}}
...
\begin{figure}[H] % Kalau menggunakan H, posisi gambar akan tepat dibawah teks
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{figure/fungsi_aktivasi.png}}
...
\begin{figure}[H] % Kalau menggunakan H, posisi gambar akan tepat dibawah teks
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{figure/max_pooling.png}}
...
\begin{figure}[H] % Kalau menggunakan H, posisi gambar akan tepat dibawah teks
    \centering
    \fbox{\includegraphics[width=1.0\textwidth]{figure/average_pooling.png}}
...
Singkatan pada tabel \ref{tab:metrik_evaluasi} merupakan singkatan dari 
masing-masing kelas, yaitu akiec untuk \textit{Actinic Keratosis and intraepithelial Carcinoma}, 
bcc untuk \textit{Basal Cell Carcinoma}, 
bkl untuk \textit{Benign Keratosis-Like Lesions}, 
df untuk \textit{Dermatofibroma}, mel untuk \textit{Melanoma}, 
nv untuk \textit{Melanocytic Nevi}, dan vasc untuk 
\textit{Vascular Lesions}. Penjelasan dari masing-masing kelas dapat 
dilihat pada dasar teori yang menjelaskan dataset DermaMNIST. \par
