...
\begin{enumerate}[noitemsep]
    ...
    \item Model dievaluasi menggunakan \textit{confuison matrix} sebagai 
    dasar metrik evaluasi seperti \textit{accuracy, precision, recall, f1-score}, 
    serta perhitungan \textit{Matthews Correlation Coefficient} (MCC). MCC 
    digunakan sebagai gambaran yang lebih mewakilkan terhadap performa model 
    pada dataset yang tidak seimbang. Dapat dilihat dari nilai MCC pada 
    setiap model yang menerapkan augmentasi kelas minoritas.
\end{enumerate}
