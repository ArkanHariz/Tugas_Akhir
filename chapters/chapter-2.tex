...
\begin{tabularx}{\textwidth}{| c | X | X | X | X |}
    ...
    1. & 
    \begin{minipage}[t]{\linewidth} \smallskip Nerma Kadric, dkk [2025] [\textit{Improving Diagnostic Accuracy of Pigmented Skin Lesions With CNNs: A Case Study with DermaMNIST Dataset}] \smallskip \end{minipage} & 
    \begin{minipage}[t]{\linewidth} \smallskip Kelemahan dataset DermaMNIST yang memiliki resolusi gambar yang rendah (28 x 28), \textit{imbalanced data}. \smallskip \end{minipage} & 
    \begin{minipage}[t]{\linewidth} \smallskip \textit{Transfer learning} arsitektur ResNet-50 dan EfficientNetV2L dengan menggunakan dataset DermaMNIST orisinal dan DermaMNIST-C (224 x 224). \smallskip \end{minipage} & 
    \begin{minipage}[t]{\linewidth} \smallskip Arsitektur EfficientNetV2L mencapai akurasi 84.90\% pada dataset DermaMNIST-C. \smallskip \end{minipage} \\ \hline

    2. & 
    \begin{minipage}[t]{\linewidth} \smallskip Ian Mateos Gonzales, dkk [2025] [\textit{Lightweight Deep Models for Dermatological Disease Detection: A Study on Instance Selection and Channel Optimization}] \smallskip \end{minipage} & 
    \begin{minipage}[t]{\linewidth} \smallskip Model \textit{deep learning} yang ringan untuk deteksi penyakit dermatologis. \smallskip \end{minipage} & 
    \begin{minipage}[t]{\linewidth} \smallskip Menggunakan \textit{Lightweight Deep Models}, melakukan \textit{instance selection} menggunakan K-Means Clustering. \smallskip \end{minipage} & 
    \begin{minipage}[t]{\linewidth} \smallskip Model dengan 472K parameter mencapai akurasi 71.57\%, dengan komputasi sebanding dengan model ResNet. \smallskip \end{minipage} \\ \hline

    3. & 
    \begin{minipage}[t]{\linewidth} \smallskip Arindam Halder, dkk [2025] [\textit{A fuzzy rank-based deep ensemble methodology for multi-class skin cancer classification}] \smallskip \end{minipage} & 
    \begin{minipage}[t]{\linewidth} \smallskip \textit{Imbalanced data} pada klasifikasi kanker kulit multi-class. \smallskip \end{minipage} & 
    \begin{minipage}[t]{\linewidth} \smallskip \textit{Fuzzy ensemble} (Xception, InceptionResNet V2, MobileNetV2). Menerapkan augmentasi data. \smallskip \end{minipage} & 
    \begin{minipage}[t]{\linewidth} \smallskip Model ensemble mencapai akurasi 95\% pada HAM10000 dan 73\% pada dataset DermaMNIST. \smallskip \end{minipage} \\ \hline

    4. & 
    \begin{minipage}[t]{\linewidth} \smallskip Gogor Putra Hafi P. G., dkk [2024] [Implementasi Algoritma CNN (ResNet-50) untuk Klasifikasi Kanker Kulit Benign dan Malignant] \smallskip \end{minipage} & 
    \begin{minipage}[t]{\linewidth} \smallskip Klasifikasi kanker kulit untuk membedakan antara Benign (jinak) dan Malignant (ganas). \smallskip \end{minipage} & 
    \begin{minipage}[t]{\linewidth} \smallskip Implementasi \textit{transfer learning} menggunakan ResNet-50 yang \textit{pre-trained}. \smallskip \end{minipage} & 
    \begin{minipage}[t]{\linewidth} \smallskip Menggunakan ResNet-50 mencapai akurasi 90\% dengan \textit{loss} 13\%. \smallskip \end{minipage} \\ \hline

    5. & 
    \begin{minipage}[t]{\linewidth} \smallskip Shuwei Shen, dkk [2022] [\textit{A Low-Cost High-Performance Data Augmentation for Deep Learning-Based Skin Lesion Classification}] \smallskip \end{minipage} & 
    \begin{minipage}[t]{\linewidth} \smallskip Data klasifikasi lesi kulit yang tidak seimbang. \smallskip \end{minipage} & 
    \begin{minipage}[t]{\linewidth} \smallskip Menggunakan arsitektur EfficientNet-B2 serta menerapkan \textit{Low Cost Augment} untuk augmentasi data. \smallskip \end{minipage} & 
    \begin{minipage}[t]{\linewidth} \smallskip Dengan EfficientNet-B2 dan \textit{Low Cost Augment}, hasil evaluasi BACC mencapai 0.853. \smallskip \end{minipage} \\ \hline
\end{tabularx}
