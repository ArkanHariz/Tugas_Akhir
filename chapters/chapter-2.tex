...
\begin{enumerate}[noitemsep]
	...
	minoritas \cite{Gusti_Haerani_Syafria_Yanto_Gusti_2024} Dengan demikian, 
	penelitian ini dapat dijadikan sebagai referensi awal dalam memahami 
	penerapan arsitektur ResNet pada citra medis. Selain itu, hasil 
	penelitian tersebut memberikan gambaran umum mengenai performa model 
	deep learning dalam konteks klasifikasi penyakit kulit.
	...
	Oleh karena itu, penelitian ini tetap memiliki kontribusi penting 
	dalam pengembangan strategi augmentasi data pada bidang klasifikasi 
	citra medis. Selain itu, pendekatan yang diusulkan dapat menjadi 
	acuan awal bagi penelitian lanjutan dengan arsitektur dan dataset 
	yang berbeda.
\end{enumerate}
